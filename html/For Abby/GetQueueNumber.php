...
if (isset($_SESSION["Stud_Id"])) {
    ...
    if(isset($_POST["btn_cashier"])){
     $queue_no = $_POST["cashier"];
         mysqli_query($connections, "INSERT into profile (Queue) VALUES('$firstname', '$lastname','$email','$password')");
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.html" class="nav-link">Queueing Section</a>
                </li>
            </ul>
            <!-- =========================================================== -->
            <!-- Right navbar links -->
        ...
        <aside class="main-sidebar sidebar-color sidebar-dark-blue elevation-4">
            ...
            <a href="index.php" class="brand-link">
                <img src="dist/img/logo.png" alt="CSPC" class="brand-image img-circle elevation-3" style="opacity: .8">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="GetQueueNumber.html" class="nav-link ">
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <h3>Please choose your office:</h3>
            <div>
                <a href="get.html"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Cashier</button></a>
                <a href="get.html"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Registrar</button></a>
                <a href="get.html"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Accounting</button></a>
                <a href="get.html"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Admission</button></a>
            </div>
        </div>
    </div>
</section>
