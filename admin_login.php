...
if (isset($_POST["logInSubmit"])) {
    ...
    $check_account = mysqli_query($connections, "SELECT * FROM admin WHERE username ='$email' and password = '$password'");
...
?>
        ...
        <div class="popup popup--icon  js_error-popup popup-visible">
            <div class="popup__background"></div>
            <div class="popup__content">
                <h3 class="popup__content__title">
                    Error
            ...
            <div class="card-body login-card-body boxx">
                ...
                <form method="POST">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Admin Username" name="email" value="<?php echo $email; ?>" required>
